...
\clearpage
\input{Sections/3_Epistemic_Capitulation}
\clearpage
\input{Sections/4_Sycophancy}
\clearpage
\input{Sections/5_Conformity}
\clearpage
\input{Sections/6_Deception_and_Concealment}
\clearpage
\input{Sections/7_Calibration_Failure}
\clearpage
\input{Sections/8_Reasoning_Degradation}
\clearpage
\input{Sections/9_Safety_and_Alignment_Erosion}
\clearpage
\input{Sections/10_Self_Preservation}
\clearpage
\input{Sections/11_Presentational_Shifts}
\clearpage
\input{Sections/12_Contested_Upside}
\clearpage
