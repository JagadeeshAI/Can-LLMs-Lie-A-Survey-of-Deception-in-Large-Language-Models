...
% Appendix temporarily disabled: its tables, protocol summaries, and transcripts
% have been moved inline into Sections 3-7 for review. Re-enable (and delete the
% now-duplicated content from the main sections) once the paper is finalized.
% \appendix
